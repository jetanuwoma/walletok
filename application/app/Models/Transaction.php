...
{	
    ...
    public function gross(){
        if ($this->Currencie()->first()->is_cripto) {
                 return $this->money_flow .' '.  $this->gross .' '. $this->currency_symbol;
            }
    ...
    public function fee(){
        if ($this->fee > 0) {
            if ($this->Currencie()->first()->is_cripto) {
                 return  '- ' . $this->fee .' '. $this->currency_symbol;
            }
    ...
    public function net(){
        ...
        if ($this->Currencie()->first()->is_cripto) {
             return $this->money_flow .' '.  $this->net .' '. $this->currency_symbol;
        }
