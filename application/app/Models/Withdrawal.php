...
{
    protected $fillable = ['user_id','transaction_state_id','send_to_platform_name', 'platform_id', 'withdrawal_method_id','gross','fee','net','json_data','currency_id', 'currency_symbol','wallet_id'];
