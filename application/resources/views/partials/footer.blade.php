			...
			<div class="row text-center text-xs-center text-sm-left text-md-left">
				<div class="col-xs-12 col-sm-6 col-md-6">
                    ...
                    <div class="body block-header">
						...
						<li><a href="{{url('/')}}/page/4"><i class="fa fa-angle-double-right"></i>{{__('About')}}</a></li>
						<li><a href="{{url('/')}}/page/5""><i class="fa fa-angle-double-right"></i>{{__('FAQ')}}</a></li>
						<li><a href="{{url('/')}}/page/3"><i class="fa fa-angle-double-right"></i>{{__('Terms of Use')}}</a></li>
						<li><a href="{{url('/')}}/page/2"><i class="fa fa-angle-double-right"></i>{{__('Privacy Policy')}}</a></li>
					</ul>
                    </div>
                	</div>
