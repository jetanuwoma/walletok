...
<head>
		...
		<link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/bootstrap.min.css')}}">
		<!-- owl.carousel css -->
		<link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/owl.carousel.css')}}">
		<link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/owl.transitions.css')}}">
       <!-- Animate css -->
        <link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/animate.css')}}">
        <!-- meanmenu css -->
        <link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/meanmenu.min.css')}}">
        <!-- Nice-select css -->
        <link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/nice-select.css')}}">
		<!-- font-awesome css -->
		<link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/font-awesome.min.css')}}">
		<link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/themify-icons.css')}}">
		<link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/flaticon.css')}}">
		<!-- magnific css -->
        <link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/magnific.min.css')}}">
		<!-- style css -->
		<link rel="stylesheet" type="text/css" href="{{URL::asset('landing/welcome/style.css')}}">
		<!-- responsive css -->
		<link rel="stylesheet" type="text/css" href="{{asset('landing/welcome/css/responsive.css')}}">

		<!-- modernizr css -->
		<script src="{{asset('landing/welcome/js/vendor/modernizr-2.8.3.min.js')}}"></script>
	</head>
		<body>
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-3">
                                    <div class="logo">
                                        <!-- Brand -->
                                        <a href="{{url('/')}}"> <img src="{{setting('site.welcome_page_logo_url')}}" class="navbar-brand page-scroll white-logo" alt="WMN">
                            ...
                            <ul class="member-actions">
                                    @if (Auth::check())
                                        <a href="{{ route('logout') }}" class="s-menu" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">{{ __('Logout') }} <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form></a>
                                        <a href="{{ url('/home') }} " class="r-menu">{{('My')}} {{ setting('site.site_name') }}</a>
                                    @else
                                        <a href="{{ url('/register') }}" class="r-menu">Create Account</a>
                                      <a href="{{ url('/login') }}" class="s-menu">{{__('Log in')}}</a>
                                    @endif
                            </ul>
                            @endif
						...
						<div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="slide-content">
                                    ...
                                    <div class="layer-1-3">
									@if (Auth::check())
                                <a href="{{url('/')}}/home" class="ready-btn left-btn">dashboard</a>
                            @else
                               <a href="{{url('/')}}/login" class="ready-btn left-btn">Get Started</a>
                            @endif
									 </div>
                                </div>
                                <!-- End Slider content -->
                    ...
                    <div class="support-all">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="about-contact text-center">
                                <div class="about-btn">
								@if (Auth::check())
                                <a href="{{url('/')}}/home" class="ab-btn right-ab-btn">dashboard</a>
                            @else
                               <a href="{{url('/')}}/login" class="ab-btn right-ab-btn">Create an Account</a>
                            @endif
								</div>
                            </div>
                        </div>
            ...
            <div class="container">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="feature-content">
                            <div class="feature-images">
                                <img src="{{asset('landing/welcome/img/feature/f1.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="feature-text">
							...
							@if (Auth::check())
                                <a href="{{url('/')}}/home" class="feature-btn">dashboard</a>
                            @else
                               <a href="{{url('/')}}/login" class="feature-btn">Get Started</a>
                            @endif
							   </div>
                    </div>
                </div>
                <div class="row margin-row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="feature-content">
                            <div class="feature-images">
                                <img src="{{asset('landing/welcome/img/feature/f2.png')}}" alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
						...
						@if (Auth::check())
                                <a href="{{url('/')}}/home" class="hire-btn">dashboard</a>
                            @else
                               <a href="{{url('/')}}/login" class="hire-btn">Get Started</a>
                            @endif
                         </div>
                    </div>
                </div>
	...
	@if (Auth::check())
                                <a href="{{url('/')}}/home" class="banner-btn">dashboard</a>
                            @else
                               <a href="{{url('/')}}/login" class="banner-btn">Open new account</a>
                            @endif                               
							  </div>
                        </div>
                    </div>
		...
		<script src="{{asset('landing/welcome/js/vendor/jquery-1.12.4.min.js')}}"></script>
		<!-- bootstrap js -->
		<script src="{{asset('landing/welcome/js/bootstrap.min.js')}}"></script>
		<!-- owl.carousel js -->
		<script src="{{asset('landing/welcome/js/owl.carousel.min.js')}}"></script>
		  <!-- stellar js -->
        <script src="{{asset('landing/welcome/js/jquery.stellar.min.js')}}"></script>
		<!-- Counter js -->
		<script src="{{asset('landing/welcome/js/jquery.counterup.min.js')}}"></script>
		<!-- waypoint js -->
		<script src="{{asset('landing/welcome/js/waypoints.js')}}"></script>
        <!-- Nice-select js -->
        <script src="{{asset('landing/welcome/js/jquery.nice-select.min.js')}}"></script>
		<!-- magnific js -->
        <script src="{{asset('landing/welcome/js/magnific.min.js')}}"></script>
        <!-- wow js -->
        <script src="{{asset('landing/welcome/js/wow.min.js')}}"></script>
        <!-- meanmenu js -->
        <script src="{{asset('landing/welcome/js/jquery.meanmenu.js')}}"></script>
		<!-- Form validator js -->
		<script src="{{asset('landing/welcome/js/form-validator.min.js')}}"></script>
		<!-- plugins js -->
		<script src="{{asset('landing/welcome/js/plugins.js')}}"></script>
		<!-- main js -->
		<script src="{{asset('landing/welcome/js/main.js')}}"></script>
	</body>
