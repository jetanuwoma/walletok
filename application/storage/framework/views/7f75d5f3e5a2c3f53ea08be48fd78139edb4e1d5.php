          ...
          <div class="card" >
            ...
            <div class="body">
              ...
              <div class="media border border-radius" style="border-radius: 6px">
                ...
                <div class="media-body">
                  <p><strong class="title pt-2 float-left">Flutterwave </strong><a href="<?php echo e(url('/')); ?>/buyvoucher/flutterwave" class="btn btn-primary float-right mr-1">Add Credit</a></p>
                </div>
              </div>
              <?php endif; ?>
